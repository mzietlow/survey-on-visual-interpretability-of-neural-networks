...
\input{Document-Structure/01_Frontmatter/01_Abstract}

% Mainmatter
\input{Document-Structure/02_Mainmatter/01_Introduction}
\input{Document-Structure/02_Mainmatter/02_General-Concepts}
\input{Document-Structure/02_Mainmatter/03_Gradient-Based}
\input{Document-Structure/02_Mainmatter/04_Perturbation-Based}
\input{Document-Structure/02_Mainmatter/05_Discussion}

% Backmatter
\input{Document-Structure/03_Appendices}
\input{Document-Structure/03_Backmatter/01_Tabellenverzeichnis}
\input{Document-Structure/03_Backmatter/02_Abbildungsverzeichnis}
\input{Document-Structure/03_Backmatter/03_Abkuerzungsverzeichnis}
\input{Document-Structure/03_Backmatter/04_Glossar}
\input{Document-Structure/05_GlossarMetadaten}
