...
Most gradient-based methods use similar concepts as was shown for example by \fcite{Acona.2018}\todo{Acona must be Ancona}. In this subsection, some general concepts will be introduced and referred to later, to ease notation and prevent accidental repetition.
